 ...
 */
public class StyledPlayerViewLatest extends FrameLayout implements AdViewProvider {
    ...
    public StyledPlayerViewLatest(Context context) {
        this(context, /* attrs= */ null);
    }

    public StyledPlayerViewLatest(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    @SuppressWarnings({"nullness:argument", "nullness:method.invocation"})
    public StyledPlayerViewLatest(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView, defStyleAttr, /* defStyleRes= */ 0);
            try {
                shutterColorSet = a.hasValue(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_shutter_background_color);
                shutterColor = a.getColor(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_shutter_background_color, shutterColor);
                playerLayoutId = a.getResourceId(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_player_layout_id, playerLayoutId);
                useArtwork = a.getBoolean(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_use_artwork, useArtwork);
                defaultArtworkId = a.getResourceId(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_default_artwork, defaultArtworkId);
                ...
                controllerShowTimeoutMs = a.getInt(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_show_timeout, controllerShowTimeoutMs);
                controllerHideOnTouch = a.getBoolean(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_hide_on_touch, controllerHideOnTouch);
                controllerAutoShow = a.getBoolean(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_auto_show, controllerAutoShow);
                showBuffering = a.getInteger(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_show_buffering, showBuffering);
                keepContentOnPlayerReset = a.getBoolean(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_keep_content_on_player_reset, keepContentOnPlayerReset);
                controllerHideDuringAds = a.getBoolean(com.google.android.exoplayer2.ui.R.styleable.StyledPlayerView_hide_during_ads, controllerHideDuringAds);
            } finally {
                a.recycle();
            }
        }
     ...
     */
    public static void switchTargetView(Player player, @Nullable StyledPlayerViewLatest oldPlayerView, @Nullable StyledPlayerViewLatest newPlayerView) {
     ...
     * {@link #switchTargetView(Player, StyledPlayerViewLatest, StyledPlayerViewLatest)} rather than this method.
    ...
    private void maybeShowController(boolean isForced) {
        ...
        if (useController()) {
            boolean wasShowingIndefinitely = controller.isFullyVisible() && controller.getShowTimeoutMs() <= 0;
    ...
    private void updateContentDescription() {
        if (controller == null || !useController) {
            ...
            setContentDescription(
                    /* contentDescription= */ controllerHideOnTouch ? getResources().getString(com.google.android.exoplayer2.ui.R.string.exo_controls_hide) : null);
        } else {
            setContentDescription(
    ...
    private final class ComponentListener implements Player.Listener, OnLayoutChangeListener, OnClickListener, StyledPlayerControlView.VisibilityListener, StyledPlayerControlView.OnFullScreenModeChangedListener {
        ...
        public void onTracksChanged(Tracks tracks) {
            ...
            Player player = checkNotNull(StyledPlayerViewLatest.this.player);
